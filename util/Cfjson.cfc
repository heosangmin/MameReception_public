<cfcomponent name="CFJSON" hint="Object for serializing and de-serializing JSON data" output="false">
<!---
/**
...
--->
	<cffunction name="encode" access="public" returntype="string" output="false">
		...
		<cfscript>
			...
			if (issimplevalue(arg) and isnumeric(arg) and refind("^0+\d+$",arg,0) is 1 ){ // added by Heo
				return '"' & ToString(arg) & '"';
			}
	...
	<cffunction name="decode" access="public" returntype="any" output="false">
